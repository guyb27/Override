...
```assembly
   ...
   0x0804849a <+6>:     sub    esp,0x20                     # alloc 32 bytes
   0x0804849d <+9>:     mov    DWORD PTR [esp],0x80485f0    #
   0x080484a4 <+16>:    call   0x8048390 <puts@plt>         # puts("*" * 35)  
   ...
   0x080484bc <+40>:    call   0x8048390 <puts@plt>         # puts("*" * 35)  
   ...
   0x080484de <+74>:    call   0x80483d0 <__isoc99_scanf@plt> # scanf("%d", char[4])
   0x080484e3 <+79>:    mov    eax,DWORD PTR [esp+0x1c]     # 
   0x080484e7 <+83>:    cmp    eax,0x149c                   # 
   0x080484ec <+88>:    jne    0x804850d <main+121>         # jmp if char[4] != 5276
