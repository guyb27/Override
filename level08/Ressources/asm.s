main:
   ...
   0x00000000004009f4 <+4>:     sub    rsp,0xb0 ; alloc 176 bytes
   0x00000000004009fb <+11>:    mov    DWORD PTR [rbp-0x94],edi
   0x0000000000400a01 <+17>:    mov    QWORD PTR [rbp-0xa0],rsi
   0x0000000000400a08 <+24>:    mov    rax,QWORD PTR fs:0x28    ; canary
   ...
   0x0000000000400aae <+190>:   call   0x4008c4 <log_wrapper>   ; log_wrapper(file1, "Starting back up: ", argv[1]);
   ...
   0x0000000000400acc <+220>:   call   0x4007c0 <fopen@plt> ; fopen(argv[1], 'r') == 0x0)
   ...
   0x0000000000400b98 <+424>:   call   0x4007b0 <open@plt>  ; open(str, 193, 432)
   ...
   0x0000000000400bf5 <+517>:   call   0x400760 <fgetc@plt> ; fgetc(file2)
...
log_wrapper:
   ...
   0x00000000004008c8 <+4>:     sub    rsp,0x130    ; 304
   ...
   0x00000000004008e4 <+32>:    mov    rax,QWORD PTR fs:0x28    ; canay
   ...
   0x0000000000400907 <+67>:    call   0x4006f0 <strcpy@plt>    ; strcpy(&addr, arg2)
