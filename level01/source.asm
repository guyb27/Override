...
=> 0x080484d8 <+8>:     sub    esp,0x60				;Creer un buffer de 96 (0xffffd730 => 0xffffd6d0)
;a_user_name  0x804a040
   0x080484db <+11>:    lea    ebx,[esp+0x1c]			;$ebx=buffer+68
   0x080484df <+15>:    mov    eax,0x0
   0x080484e4 <+20>:    mov    edx,0x10
   0x080484e9 <+25>:    mov    edi,ebx
   0x080484eb <+27>:    mov    ecx,edx
   0x080484ed <+29>:    rep stos DWORD PTR es:[edi],eax 	;memset(buffer+68, 0, 16)//buffer+68 => buffer+84
   ...
   0x08048528 <+88>:    call   0x8048370 <fgets@plt>		;fgets(a_user_name, 256, 0)
   ...
   0x08048574 <+164>:   call   0x8048370 <fgets@plt>		;fgets(0xffffd6ec, 100, 0)
