...
verify_user_name:
   ...
   0x0804848b <+39>:    repz cmps BYTE PTR ds:[esi],BYTE PTR es:[edi]   ; memcmp(a_user_name, "dat_wil", 7)
...
verify_user_pass:
   ...
   0x080484bb <+24>:    repz cmps BYTE PTR ds:[esi],BYTE PTR es:[edi]   ; memcmp(buf_1, "admin", 5)
...
main:
   ...
   0x080484d8 <+8>:     sub    esp,0x60   ; alloc 96
   0x080484db <+11>:    lea    ebx,[esp+0x1c]   ; buf_1[68]
   0x080484df <+15>:    mov    eax,0x0
   0x080484e4 <+20>:    mov    edx,0x10
   0x080484e9 <+25>:    mov    edi,ebx
   0x080484eb <+27>:    mov    ecx,edx
   0x080484ed <+29>:    rep stos DWORD PTR es:[edi],eax  ; memset(buf_1, 0, 64) // buffer+68 => buffer+84
   0x080484ef <+31>:    mov    DWORD PTR [esp+0x5c],0x0  ; memset(&buf_1[64], 0, 4) 
   ...
   0x0804853b <+107>:   je     0x8048550 <main+128>   ; jmp if 0 == verify_user_name()
   ...
   0x08048574 <+164>:   call   0x8048370 <fgets@plt>  ; fgets(buf_1, 100, stdin)
   0x08048579 <+169>:   lea    eax,[esp+0x1c]
   0x0804857d <+173>:   mov    DWORD PTR [esp],eax
   0x08048580 <+176>:   call   0x80484a3 <verify_user_pass> ; verify_user_pass(buf_1)
   0x08048585 <+181>:   mov    DWORD PTR [esp+0x5c],eax 
   0x08048589 <+185>:   cmp    DWORD PTR [esp+0x5c],0x0
   0x0804858e <+190>:   je     0x8048597 <main+199>   ; jmp if 0 == verify_user_pass(buf_1)
   0x08048590 <+192>:   cmp    DWORD PTR [esp+0x5c],0x0
   0x08048595 <+197>:   je     0x80485aa <main+218>   ; jmp if 0 == verify_user_pass(buf_1)
