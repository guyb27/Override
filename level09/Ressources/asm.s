main:
   ...
   0x0000000000000ab3 <+11>:    call   0x730 <puts@plt>  ; puts(Enter your...)
...
handle_msg:
   ...
   0x00000000000008c4 <+4>:     sub    rsp,0xc0 ; 192 bytes
   ...
   0x0000000000000906 <+70>:    lea    rax,[rbp-0xc0] ; c_1[140]
   0x000000000000090d <+77>:    mov    rdi,rax
   0x0000000000000910 <+80>:    call   0x9cd <set_username> ; set_username(c_1)
...
set_username:
   ...
   0x00000000000009d1 <+4>:     sub    rsp,0xa0 ; 160 bytes
   0x00000000000009d8 <+11>:    mov    QWORD PTR [rbp-0x98],rdi   ; i_1
   0x00000000000009df <+18>:    lea    rax,[rbp-0x90] ; c_1
   ...
   0x00000000000009f9 <+44>:    rep stos QWORD PTR es:[rdi],rax   ; bzero(128)
   ...
   0x0000000000000a38 <+107>:   call   0x770 <fgets@plt> ; fgets(c_1, 128, stdin);
   ...
   0x0000000000000a4b <+126>:   movzx  ecx,BYTE PTR [rbp+rax*1-0x90] ; c_1[i_2]
   ...
   0x0000000000000a5f <+146>:   mov    BYTE PTR [rdx+rax*1+0x8c],cl  ; arg[140 + i_2]
   0x0000000000000a66 <+153>:   add    DWORD PTR [rbp-0x4],0x1
   0x0000000000000a6a <+157>:   cmp    DWORD PTR [rbp-0x4],0x28   ; for (i_2 = 0; i_2 < 41; i_2 += 1)
   ...
   0x0000000000000a7d <+176>:   test   al,al ; c_1[i_2] != '\0'
...
set_msg:
   ...
   0x0000000000000936 <+4>:     sub    rsp,0x410   ; 1040 bytes
   0x000000000000093d <+11>:    mov    QWORD PTR [rbp-0x408],rdi  ; -1032
   0x0000000000000944 <+18>:    lea    rax,[rbp-0x400]   ; -1024
   ...
   0x000000000000095e <+44>:    rep stos QWORD PTR es:[rdi],rax   ; bzero(c_1, 1024);
   ...
   0x000000000000099d <+107>:   call   0x770 <fgets@plt> ; fgets(c_1, 1024, stdin);
