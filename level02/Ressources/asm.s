...
main:
   ...
   0x00000000004008b6 <+162>:   jne    0x4008e6 <main+210> ; jmp if fopen() != 0
   ...
   0x00000000004008d7 <+195>:   call   0x400720 <fwrite@plt>    ; fwrite("ERROR: failed to read password file\n", 1, 36, stderr);
   ...
   0x0000000000400901 <+237>:   call   0x400690 <fread@plt> ; fread(buf_2, 1, 29, file)
   ...
   0x0000000000400918 <+260>:   call   0x4006d0 <strcspn@plt> ; strcspn(buf_2, "\n")
   0x000000000040091d <+265>:   mov    BYTE PTR [rbp+rax*1-0xa0],0x0
   0x0000000000400925 <+273>:   cmp    DWORD PTR [rbp-0xc],0x29
   0x0000000000400929 <+277>:   je     0x40097d <main+361>  ; jmp if fread() != 41
   ...
   0x0000000000400984 <+368>:   call   0x4006a0 <fclose@plt> ; fclose(file)
   ...
   0x00000000004009d9 <+453>:   call   0x4006f0 <fgets@plt> ; fgets(buf_1, 100, stdin)
   0x00000000004009de <+458>:   lea    rax,[rbp-0x70]
   0x00000000004009e2 <+462>:   mov    esi,0x400bf5
   0x00000000004009e7 <+467>:   mov    rdi,rax
   0x00000000004009ea <+470>:   call   0x4006d0 <strcspn@plt> ; strcspn(buf_1, "\n")
   ...
   0x0000000000400a1f <+523>:   call   0x4006f0 <fgets@plt> ; fgets(buf_3, 100, stdin)
   0x0000000000400a24 <+528>:   lea    rax,[rbp-0x110]
   0x0000000000400a2b <+535>:   mov    esi,0x400bf5
   0x0000000000400a30 <+540>:   mov    rdi,rax
   0x0000000000400a33 <+543>:   call   0x4006d0 <strcspn@plt> ; strcspn(buf_3, "\n")
   ...
   0x0000000000400a4a <+566>:   lea    rcx,[rbp-0x110]  ; buf_3
   0x0000000000400a51 <+573>:   lea    rax,[rbp-0xa0]   ; buf_2
   0x0000000000400a58 <+580>:   mov    edx,0x29
   0x0000000000400a5d <+585>:   mov    rsi,rcx
   0x0000000000400a60 <+588>:   mov    rdi,rax
   0x0000000000400a63 <+591>:   call   0x400670 <strncmp@plt>   ; strncmp(buf_2, buf_3, 41)
   0x0000000000400a68 <+596>:   test   eax,eax
   0x0000000000400a6a <+598>:   jne    0x400a96 <main+642>  ; jmp if strncmp != 0
   ...
   0x0000000000400aa2 <+654>:   call   0x4006c0 <printf@plt> ; printf(buf_1)
